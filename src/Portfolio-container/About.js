        ...
        return (
            <section className='About-container' id='About'>
                ...
                <div className='heading'>
                    <h1 className='head1'>A</h1>
                    <h1 className='head2'>bout</h1>
                </div>
                <div className='aboutBlock'>
                   <div className='introbox'>
                    <h1>Anuj Guha</h1>
                    <h3>Intern @ IAssess_digital </h3>
                    <p>I am a Full Stack Developer and a Problem-Solving enthusiast pursuing Computer Science engineering from MITS, Gwalior. </p>
                    <p>I have a passion for software development with a diverse skillset ranging from the MERN stack to a stronghold on data structures and algorithms. </p>
